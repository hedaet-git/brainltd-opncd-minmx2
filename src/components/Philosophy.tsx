      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-warm-off-white/70 text-lg leading-relaxed mb-8">
              {philosophy.story}
            </p>
            ...
            {founders.map((founder, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-muted-brass/20 flex items-center justify-center text-muted-brass font-playfair text-xl font-bold">
                    {founder.name[0]}
                  </div>
                  <div>
